...
public class TeleOpFieldOriented extends OpMode {
    // The on-board IMU (gyroscope) in the REV Expansion Hub.
    ...
    public void init() {
        ...
        // Initialize the IMU using radians for an angle unit.
    ...
    public void loop() {
        ...
        //
        // Simply adding the desired translation angle to the current robot
        // orientation angle (both in radians) will yield field-oriented
